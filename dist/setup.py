...
def generate_version_py():
    with open(os.path.join(getmp_mpdir(), 'version.py'), 'w') as version_py:
        ...
        version_py.write('HTTPD = "/usr/sbin/apache2"\n')
        version_py.write('HTTPD_VERSION = "2.4.39"\n')
        version_py.write('APR_VERSION = "1.6.5"\n')
        version_py.write('LIBEXECDIR = "/usr/lib/apache2/modules"\n')
        version_py.write('SYSCONFDIR = ""\n')
        version_py.write('TEST_MOD_PYTHON_SO = "/root/mod_python/src/mod_python.so" #NB: This is for test.py only\n')
        version_py.write('TESTHOME = "/root/mod_python/test"\n')
        version_py.write('PYTHON_BIN = "/usr/bin/python"\n')
